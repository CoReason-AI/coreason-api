...
from coreason_api.dependencies import get_identity_manager, get_gatekeeper, get_session_manager, get_trust_anchor
...
def test_generate_agent(client, mock_identity, mock_gatekeeper):
    ...
    response = client.post(
        "/v1/architect/generate",
        json={"prompt": "Build a finance agent"},
